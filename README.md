<p align="center">
  <a href="https://github.com/FRIMANCS/wizwizxui-timebot" target="_blank" rel="noopener noreferrer">
    <picture>
...
<p align="center">
Easy to sell with <a href="https://github.com/FRIMANCS/wizwizxui-timebot">wizwizxui-timebot</a> easy install with few clicks
</p>
...
<br>
    <a align="center">
        <img src="https://github.com/FRIMANCS/wizwizxui-timebot/assets/27927279/f6635ea5-ab26-4c64-a7b8-952203f79763" />
    </a>     
<br>
<br>
...
```
bash <(curl -s https://raw.githubusercontent.com/FRIMANCS/wizwizxui-timebot/main/wizwiz.sh)
```
...
```
bash <(curl -s https://raw.githubusercontent.com/FRIMANCS/wizwizxui-timebot/main/update.sh)
```
