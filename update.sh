...
do
	case $opt in
		"Update bot")
			...
			sleep 3
			git clone https://github.com/FRIMANCS/wizwizxui-timebot.git /var/www/html/wizwizxui-timebot
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/FRIMANCS/wizwizxui-timebot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
